...
let events = document.querySelector('.events');
 if(window.pageYOffset >= events.offsetTop){
      let endDate = new Date("Dec 31,2021 16:00:59").getTime();
 ...
 document.querySelector('.events .box.days h3').textContent = time.days;
 document.querySelector('.events .box.hours h3').textContent = time.hours;
 document.querySelector('.events .box.minutes h3').textContent = time.minutes;
 document.querySelector('.events .box.seconds h3').textContent = time.seconds;
        },1000); 
        }
